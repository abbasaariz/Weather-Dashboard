...
function displayWeather() {
    var queryURL = "https://api.openweathermap.org/data/2.5/weather?q=524901&APPID=203c06c77c2f8b15c22f10329b14a47b" + cityName + APIkey;
    ...
    function searchCity(cityname) {
        ...
        $.ajax({
            ...
            dataType: "json",
            var queryURL = "https://api.openweathermap.org/data/2.5/weather?q=203c06c77c2f8b15c22f10329b14a47b" + cityname + "&units=imperial&appid=203c06c77c2f8b15c22f10329b14a47b";
        })

        $.ajax({
            var queryURLforecast = "https://api.openweathermap.org/data/2.5/forecast?q=203c06c77c2f8b15c22f10329b14a47b" + cityname + "&units=imperial&appid=203c06c77c2f8b15c22f10329b14a47b";
        })
